      ...
      <ListItem thumbnail>
        <Left>
          <Thumbnail
            ...
            source={{
              uri:
                this.data.urlToImage != null //urlToImage,taken from our news json data for image property
                  ? this.data.urlToImage //if no image for articles i.e,null,load some default image
